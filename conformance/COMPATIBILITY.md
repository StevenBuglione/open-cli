...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `1.0.0` | `0.1.0` | `StevenBuglione/oas-cli-go@main` | partial | passing | passing | passing | partial | partial | passing |
...
- implementation verification in `oas-cli-go` for runtime transport and auth behavior
